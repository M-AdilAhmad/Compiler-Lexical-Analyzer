const keywords = ['abstract', 'arguments', 'await', 'boolean', 'break',	'byte', 'case' ,'catch', 'char', 'class', 'const', 'continue',
'debugger',	'default', 'delete', 'do', 'double', 'else', 'enum', 'evalexport', 'extends', 'false', 'final', 'finally', 'float', 'for',	
...
const tokens = tokenize(sourceCode[3])
console.log(tokens)
